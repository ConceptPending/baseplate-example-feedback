...
This is **Feedback Inbox**, a small app built on [Baseplate](https://github.com/ConceptPending/baseplate)
by applying the [public-submission-and-admin-queue recipe](https://github.com/ConceptPending/baseplate/blob/main/docs/recipes/public-submission-and-admin-queue.md).
All the conventions below come from Baseplate; nothing here is novel. `README.md`
explains what the app does.

Full stack: FastAPI + Next.js 16 + PostgreSQL.

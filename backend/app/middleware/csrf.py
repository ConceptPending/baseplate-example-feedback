...
# endpoint itself ISSUES the token. The public submissions endpoint is
# unauthenticated — there's no session identity for a cross-origin attacker
# to abuse, so rate-limiting + input validation cover that surface instead.
# Add new exemptions sparingly and only for unauthenticated endpoints.
